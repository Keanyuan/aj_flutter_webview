...
public class AjFlutterWebviewPlugin implements MethodCallHandler,PluginRegistry.ActivityResultListener {

  private Activity activity;
  private WebviewManager webViewManager;
  static MethodChannel channel;
  private static final String CHANNEL_NAME = "aj_flutter_webview";

  private AjFlutterWebviewPlugin(Activity activity) {
    this.activity = activity;
  }

  public static void registerWith(PluginRegistry.Registrar registrar) {
    channel = new MethodChannel(registrar.messenger(), CHANNEL_NAME);
    final  AjFlutterWebviewPlugin instance = new AjFlutterWebviewPlugin(registrar.activity());
...
//  canBack
  private void canBack(MethodCall call, final MethodChannel.Result result) {
    webViewManager.canGoBack(call, result);
  }

  //canForward
  private void canForward(MethodCall call, final MethodChannel.Result result) {
    webViewManager.canGoForward(call, result);
  }
